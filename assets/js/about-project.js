    ...
    aboutProjectSection.innerHTML = `
        <div class="modal_container">
            ...
            <footer class="form_footer" id="about_project_footer">
                <p id="last_update"></p>
                <a href="https://github.com/Anutosh720/to-do-list" target="_blank" rel="noopener noreferrer">Visit Github for more info.</a>
            </footer>
        </div>
    `;
    
    fetch("https://api.github.com/repos/Anutosh720/to-do-list/branches/release")
